...
The goal of this  exercise is to document what you are doing when things do not go according to plan. 

We have a specific use case in mind: we want to build a book from a github repository. 
...
Build the html version of the newest edition for Hadley Wickham's book `Advanced R Programming` from a github repository.

Steps:

1. Clone the repository [https://github.com/hadley/adv-r](https://github.com/hadley/adv-r).
...
You can write your experience directly into the `READEM.Rmd` file. 
